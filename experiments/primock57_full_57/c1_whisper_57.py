"""Transcribe all 57 PriMock57 consultations with Whisper-tiny. Writes c1_whisper_raw.json."""
import json
import re
import sys
...
def get_first_n_consultation_ids(n: int = NUM_CONSULTATIONS) -> list:
...
def main():
    ...
    print(f"Transcribing up to {NUM_CONSULTATIONS} consultations (found {len(ids)} note stems)")
